...
function artistImageUrl(url, colorObject) {
  ...
  var mask = "https://s3-us-west-2.amazonaws.com/batserver-static-assets/shared/imagegen/paper-texture" +
    textureNumber + ".png";
  var format = "png";
  ...
  if (colorObject) {
    ...
    imageGenOptions.blend = colorString;
  }

  var url = client.path(url).toUrl(imageGenOptions).toString();
  return url;
}
